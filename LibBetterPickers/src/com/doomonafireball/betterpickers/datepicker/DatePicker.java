...
public class DatePicker extends LinearLayout implements Button.OnClickListener,
    ...
    private class KeyboardPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup collection, int position) {
            ...
            if (mDateFormatOrder[position] == DateFormatConstant.MONTH) {
                // Months
            ...
            } else if (mDateFormatOrder[position] == DateFormatConstant.DATE) {
                // Date
            ...
            } else if (mDateFormatOrder[position] == DateFormatConstant.YEAR) {
                // Year
    ...
    protected void doOnClick(View v) {
        if (v == mDelete) {
            ...
            switch (mDateFormatOrder[mKeyboardPager.getCurrentItem()]) {
                case DateFormatConstant.MONTH:
                    if (mMonthInput != -1) {
                        mMonthInput = -1;
                    }
                    break;
                case DateFormatConstant.DATE:
    ...
    public void setDate(int year, int monthOfYear, int dayOfMonth) {
        ...
        for (int i = 0; i < mDateFormatOrder.length; i++) {
            ...
            if (c == DateFormatConstant.MONTH && monthOfYear == -1) {
                mKeyboardPager.setCurrentItem(i, true);
                break;
            } else if (c == DateFormatConstant.DATE && dayOfMonth <= 0) {
                mKeyboardPager.setCurrentItem(i, true);
                break;
            } else if (c == DateFormatConstant.YEAR && year <= 0) {
                mKeyboardPager.setCurrentItem(i, true);
                break;
            }
        }
